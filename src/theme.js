...
export const THEME_PRESETS = {
  ...
  red: {
    ...
    headFrom: "#A82026", headTo: "#A82026", headBFrom: "#135F86", headBTo: "#135F86", badgeBg: "transparent",
  ...
  green: {
    ...
    headFrom: "#1DA844", headTo: "#1DA844", headBFrom: "#B44E18", headBTo: "#B44E18", badgeBg: "transparent",
  ...
  purple: {
    ...
    headFrom: "#6D1DA8", headTo: "#6D1DA8", headBFrom: "#B4571F", headBTo: "#B4571F", badgeBg: "transparent",
  ...
  yellow: {
    ...
    headFrom: "#9C7A08", headTo: "#9C7A08", headBFrom: "#135F86", headBTo: "#135F86", badgeBg: "transparent",
  ...
  orange: {
    ...
    headFrom: "#C46312", headTo: "#C46312", headBFrom: "#135F86", headBTo: "#135F86", badgeBg: "transparent",
  ...
  deepblue: {
    ...
    headFrom: "#1D5AA8", headTo: "#1D5AA8", headBFrom: "#B4571F", headBTo: "#B4571F", badgeBg: "transparent",
  ...
  dark: {
    ...
    headFrom: "#2E6FA0", headTo: "#2E6FA0", headBFrom: "#A8542A", headBTo: "#A8542A", badgeBg: "#E8EDF2",
  ...
  sakura: {
    ...
    headFrom: "#B82064", headTo: "#B82064", headBFrom: "#0F6E86", headBTo: "#0F6E86", badgeBg: "transparent",
  ...
  mint: {
    ...
    headFrom: "#0F9682", headTo: "#0F9682", headBFrom: "#A84E1C", headBTo: "#A84E1C", badgeBg: "transparent",
  ...
  sumi: {
    ...
    headFrom: "#3A3A38", headTo: "#3A3A38", headBFrom: "#9A1B09", headBTo: "#9A1B09", badgeBg: "transparent",
  ...
  midnight: {
    ...
    headFrom: "#3D5A8F", headTo: "#3D5A8F", headBFrom: "#A0562E", headBTo: "#A0562E", badgeBg: "#E5EAF4",
  ...
  nibi: {
    ...
    headFrom: "#4E7089", headTo: "#4E7089", headBFrom: "#8F5636", headBTo: "#8F5636", badgeBg: "transparent",
  ...
  kinari: {
    ...
    headFrom: "#70634A", headTo: "#70634A", headBFrom: "#7C4736", headBTo: "#7C4736", badgeBg: "transparent",
  ...
  susutake: {
    ...
    headFrom: "#7A6444", headTo: "#7A6444", headBFrom: "#8F5638", headBTo: "#8F5638", badgeBg: "#E6E0D8",
  ...
  koke: {
    ...
    headFrom: "#4E6B4A", headTo: "#4E6B4A", headBFrom: "#8F5F38", headBTo: "#8F5F38", badgeBg: "#DFE6DC",
